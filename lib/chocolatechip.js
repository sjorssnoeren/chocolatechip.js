        ...
        <div class="choc-float--clearfix">
          ...
          <div class="choc-tabs__dynamic-content choc-float--left choc-padding--small">
            <div class="choc-tabs__item" data-choc-tab="0">
              ...
              <p>De functionele cookies zijn vereist voor de werking van de website. Deze cookies houden anoniem statistieken bij. Omdat de werking van de website niet kan worden gegarandeerd zonder deze cookies, kunt u deze cookies niet weigeren. U kunt deze cookies verwijderen in uw browserinstellingen.</p>
            </div>
            ...
            <div class="choc-tabs__item" data-choc-tab="1">
              ...
              <p>De voorkeurs cookies zijn niet essentieel voor de werking van de websites maar bevorderen wel de gebruikerservaring. Deze cookies zorgen ervoor dat de gebruikerservaring optimaal is.</p>
            </div>
            ...
            <div class="choc-tabs__item" data-choc-tab="2">
              ...
              <p>De analytische cookies verzamelen informatie over het gedrag van gebruikers van deze website. Dit helpt ons deze website te optimaliseren en leert ons de gebruiker te begrijpen. Ook wordt hieruit opgemaakt hoe effectief de marketingcampagnes zijn.</p>
            </div>
            ...
            <div class="choc-tabs__item" data-choc-tab="3">
              ...
              <p>De advertentie cookies brengen uw surf gedrag in kaart voor advertentienetwerken. Door middel van deze cookies kunnen deze netwerken jouw de juiste advertenties aanbieden. Ook voorkomen deze cookies dat een advertentie niet meerdere malen aan dezelfde gebruiker wordt getoond.</p>
            </div>
          </div>
        </div>
