  ...
  `<div class="choc-modal__overlay">
      <div class="choc-modal">
        <div class="choc-padding--v-medium choc-padding--h-small">
          ...
          <h3>${translations["modalTemplate.instellen"]}</h3>
        </div>
        ...
        <div class="choc-float--clearfix">
          <div class="choc-tabs__navigation">
            <ul>
              <li class="choc-tabs__link choc-tabs__link--state-active choc-display--block"><a data-choc-action="show-tab" href="#">${translations["modalTemplate.functioneleHeader"]}</a></li>
              <li class="choc-tabs__link choc-display--none" data-choc-preference-tab="userPreferences"><a data-choc-action="show-tab" href="#">${translations["modalTemplate.voorkeursHeader"]}</a></li>
              <li class="choc-tabs__link choc-display--none" data-choc-preference-tab="analytics"><a data-choc-action="show-tab" href="#">${translations["modalTemplate.analytischeHeader"]}</a></li>
              <li class="choc-tabs__link choc-display--none" data-choc-preference-tab="advertisements"><a data-choc-action="show-tab" href="#">${translations["modalTemplate.advertentieHeader"]}</a></li>
            </ul>
          </div>
          ...
          <div class="choc-tabs__dynamic-content choc-float--left choc-padding--small">
            <div class="choc-tabs__item" data-choc-tab="0">
              <div class="choc-tabs__header">
                <h3>${translations["modalTemplate.functioneleHeader"]}</h3>

                <label class="choc-form__toggle">
                  <input type="checkbox" data-choc-preference="functional" disabled>
                  ${translations["modalTemplate.verplicht"]}
                </label>
              </div>

              <p>${translations["modalTemplate.functioneleText"]}</p>
            ...
            <div class="choc-tabs__item" data-choc-tab="1">
              <div class="choc-tabs__header">
                <h3>${translations["modalTemplate.voorkeursHeader"]}</h3>

                <label class="choc-form__toggle">
                  <input type="checkbox" data-choc-preference="userPreferences">
                  <span>${translations["modalTemplate.inschakelen"]}</span>
                </label>
              </div>

              <p>${translations["modalTemplate.voorkeursText"]}</p>
            ...
            <div class="choc-tabs__item" data-choc-tab="2">
              <div class="choc-tabs__header">
                <h3>${translations["modalTemplate.analytischeHeader"]}</h3>
              ...
              <p>${translations["modalTemplate.analytischeText"]}</p>
            ...
            <div class="choc-tabs__item" data-choc-tab="3">
              <div class="choc-tabs__header">
                <h3>${translations["modalTemplate.advertentieHeader"]}</h3>
              ...
              <p>${translations["modalTemplate.advertentieText"]}</p>
...
global.ChocolateChip = {
  ...
  eat(options) {
    const defaultTranslations = {
      nl: {
        ...
        'modalTemplate.instellen': 'Cookies instellen',
        'modalTemplate.functioneleHeader': 'Functionele cookies',
        'modalTemplate.functioneleText': 'Functionele cookies houden anoniem statistieken bij en zijn vereist voor de werking van de website. Omdat de werking van de website niet kan worden gegarandeerd zonder deze cookies, kun je deze cookies niet weigeren. Je kunt deze cookies eventueel wel verwijderen in je browserinstellingen.',
        'modalTemplate.voorkeursHeader': 'Voorkeurs cookies',
        'modalTemplate.voorkeursText': 'Voorkeurscookies zijn niet essentieel voor de werking van de website, maar bevorderen wel de gebruikerservaring. Deze cookies zorgen ervoor dat je gebruikerservaring optimaal is.',
        'modalTemplate.analytischeHeader': 'Analytische cookies',
        'modalTemplate.analytischeText': 'Analytische cookies verzamelen informatie over het gedrag van gebruikers van de website. Dit leert ons om deze gebruikers beter te begrijpen en helpt ons om deze website te optimaliseren. Ook wordt hieruit opgemaakt hoe effectief de marketingcampagnes via deze website zijn.',
        'modalTemplate.advertentieHeader': 'Advertentie cookies',
        'modalTemplate.advertentieText': 'Advertentiecookies brengen je surfgedrag in kaart voor advertentienetwerken. Door middel van deze cookies kunnen deze netwerken je advertenties aanbieden die aansluiten bij jouw interesses. Ook voorkomen deze cookies dat dezelfde advertentie niet meerdere malen aan dezelfde gebruiker wordt getoond.',
        'modalTemplate.privacy': 'Privacy Policy',
        'modalTemplate.actionCookies': 'Alle cookies toestaan',
        'modalTemplate.actionWebsite': 'Verder naar website',
        'modalTemplate.verplicht': 'Verplicht',
        'modalTemplate.inschakelen': 'Inschakelen',
        'modalTemplate.ingeschakeld': 'Ingeschakeld',
      },
      en: {
      },
    };
    ...
    this._options = Object.assign({}, this._options, {translations} );
  ...
  _didUpdateState(prevState) {
    ...
    Object.keys(cookiePreferences).forEach((key) => {
      ...
      if (span != null) {
        span.innerHTML = checked ? this._options.translations['modalTemplate.inschakelen'] : this._options.translations['modalTemplate.ingeschakeld'];
      }
